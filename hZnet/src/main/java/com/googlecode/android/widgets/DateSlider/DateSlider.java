...
public abstract class DateSlider extends Dialog {
    ...
    /**
     * This method allows to change the displayed time of the slider(s). this
     * can be handy if you need to invoke the dialog several times using
     * OnPrepareDialog.
     * 
