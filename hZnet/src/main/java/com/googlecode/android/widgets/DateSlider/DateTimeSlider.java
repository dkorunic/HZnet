 ...
 * 
 * Later modifications by Dinko Korunic <dinko.korunic@gmail.com>
 */
...
public class DateTimeSlider extends DateSlider {
    ...
    public static final int MINUTEINTERVAL = 60;
    ...
    protected Labeler monthLabeler = new Labeler() {
        ...
        protected TimeObject timeObjectfromCalendar(Calendar c) {
            ...
            return new TimeObject(String.format(mLocale, "%tB %tY", c, c), startTime, endTime);
        }
    ...
    protected Labeler dayLabeler = new Labeler() {
        ...
        protected TimeObject timeObjectfromCalendar(Calendar c) {
            ...
            c.set(Calendar.MILLISECOND, 999);
            long endTime = c.getTimeInMillis();
            return new TimeObject(String.format(mLocale, "%td %ta", c, c), startTime, endTime);
        }
    ...
    protected Labeler timeLabeler = new Labeler() {
        ...
        protected TimeObject timeObjectfromCalendar(Calendar c) {
            ...
            c.set(Calendar.MILLISECOND, 0);
            long startTime = c.getTimeInMillis();
            return new TimeObject(String.format(mLocale, "%tR", c), startTime, endTime);
        }
    };
}
