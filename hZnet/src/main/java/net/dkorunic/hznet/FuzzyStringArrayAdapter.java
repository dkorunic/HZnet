 ...
 *
 * This code has been imported from Android AOSP 2.3.3_r1:
 *   http://grepcode.com/file/repository.grepcode.com/java/ext/com.google.android/android/2.3.3_r1/android/widget/ArrayAdapter.java/?v=source
 */
 ...
 * TextView in the larger layout resource. However the TextView is referenced,
 * it will be filled with the toString() of each object in the array. You can
 * add lists or arrays of custom objects. Override the toString() method of your
 * objects to determine what text will be displayed for the item in the list. To
 * use something other than TextViews for the array display, for instance,
 ...
 * view you want.
 */
public class FuzzyStringArrayAdapter<T> extends BaseAdapter implements Filterable {
    /**
     ...
     */
    public FuzzyStringArrayAdapter(Context context, int textViewResourceId) {
     ...
     */
    public FuzzyStringArrayAdapter(Context context, int resource, int textViewResourceId) {
     ...
     */
    public FuzzyStringArrayAdapter(Context context, int textViewResourceId, T[] objects) {
     ...
     * @param objects            The objects to represent in the ListView.
     */
    public FuzzyStringArrayAdapter(Context context, int textViewResourceId, List<T> objects) {
    ...
    /**
     * Creates a new FuzzyStringArrayAdapter from external resources. The
     * content of the array is obtained through
     ...
     * @return An FuzzyStringArrayAdapter<CharSequence>.
     */
    public static FuzzyStringArrayAdapter<CharSequence> createFromResource(Context context,
                                                                           int textArrayResId, int textViewResId) {
        CharSequence[] strings = context.getResources().getTextArray(textArrayResId);
        return new FuzzyStringArrayAdapter<CharSequence>(context, textViewResId, strings);
    }
    ...
    private void init(Context context, int resource, int textViewResourceId, List<T> objects) {
        DiffMatchPatch.Match_Threshold = 0.21f; // enforce closer matches
        mContext = context;
    ...
    private View createViewFromResource(int position, View convertView, ViewGroup parent,
        ...
        try {
            ...
            Crashlytics.getInstance().core.log(Log.ERROR, "FuzzyStringArrayAdapter", "You must supply a resource ID for a TextView");
            throw new IllegalStateException(
                    "FuzzyStringArrayAdapter requires the resource ID to be a TextView", e);
        }
        ...
        protected FilterResults performFiltering(CharSequence prefix) {
            ...
            if (null == prefix || 0 == prefix.length()) {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    if (DiffMatchPatch.match_main(valueText, prefixString, 0) != -1) {
                        newValues.add(value);
                    }
                }
